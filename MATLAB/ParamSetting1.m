...
param.sx = ROI*(0.388*460/880)/2; % mm (real size)
param.sy = ROI*(0.388*460/880)/2; % mm
param.sz = ROI*(0.388*460/880)/2; % mm
...
param.dang = 360/200; % angular step size (deg)
